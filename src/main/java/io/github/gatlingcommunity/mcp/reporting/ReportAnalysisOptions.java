...
public record ReportAnalysisOptions(
        String contentType,
        double errorRateThreshold,
        long p95ThresholdMs,
        long p99ThresholdMs
) {
    public ReportAnalysisOptions {
    ...
    public static ReportAnalysisOptions defaults() {
        return new ReportAnalysisOptions("AUTO", 1.0, 1_000, 2_000);
    }
